...
ActiveRecord::Schema.define(version: 20150222082958) do
  ...
  add_index "users", ["provider_user_id", "provider"], name: "index_users_on_provider_user_id_and_provider", unique: true, using: :btree
